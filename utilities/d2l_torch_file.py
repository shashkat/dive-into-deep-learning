...
class Module(d2l.nn_Module, d2l.HyperParameters):
    ...
    def training_step(self, batch):
        l = self.loss(self(*batch[:-1]), batch[-1]) # batch[:-1] means all dimensions except last
...
class EncoderDecoder(d2l.Classifier):
    ...
    def predict_step(self, batch, device, num_steps,
        ...
        batch = [d2l.to(a, device) for a in batch] # transfer the data from batch to the device passed as argument
